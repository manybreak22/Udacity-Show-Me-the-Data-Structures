...
def huff_encode(data):
    if not data:
        ...
        while len(mappedSortedFrequencies) > 1:
            ...
            insertElement(rootNode, mappedSortedFrequencies)
...
def insertElement(node, sortedFrequencies):
...
def test_one():
    ...
    encoded_data, tree = huff_encode(one_word_sentence)

    print("The size of the encoded data is: {}\n".format(
        sys.getsizeof(int(encoded_data, base=2))))
    print("The content of the encoded data is: {}\n".format(encoded_data))

    decoded_data = huff_decode(encoded_data, tree.root)
...
def test_two():
    value_great_sentence = "Python is life"

    print("The size of the data is: {}\n".format(
        sys.getsizeof(value_great_sentence)))
    print("The content of the data is: {}\n".format(value_great_sentence))

    encoded_data, tree = huff_encode(value_great_sentence)
...
def test_three():
    ...
    encoded_data, tree = huff_encode(empty_sentence)
